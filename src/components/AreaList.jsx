    ...
    return (
      ...
      <div className="flex flex-col px-12 py-12 text-sm whitespace-nowrap bg-white rounded-xl border border-solid shadow-2xl border-neutral-200 max-w-[675px] text-zinc-600 ml-10">
        ...
        <select
            ...
            className="justify-center items-start py-4 pr-16 pl-3 mt-3 bg-white rounded-xl border border-gray-300 border-solid"
          >
            <option value="">Select region</option>
            {dummyRegionOptions.map(option => (
...
<label className="font-medium mt-3">Area</label>
        <input
          type="text"
